...
function AIGenerate({ onImageView }) {
  const { isDark } = useTheme();

  const files = [
    { name: 'ai_gen1.jpg', size: '75.32 KB', date: '2025-02-25 06:33:21', type: 'image' },
    { name: 'ai_gen2.jpg', size: '82.18 KB', date: '2025-02-25 06:32:57', type: 'image' },
  ];
