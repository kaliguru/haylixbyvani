...
function UploadFiles({ onImageView }) {
  const { isDark } = useTheme();

  const files = [
    { name: 'upload1.jpg', size: '62.45 KB', date: '2025-02-25 05:33:21', type: 'image' },
    { name: 'upload2.jpg', size: '48.92 KB', date: '2025-02-25 05:32:57', type: 'image' },
  ];
