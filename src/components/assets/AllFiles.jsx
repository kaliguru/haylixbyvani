...
function AllFiles({ onImageView }) {
  const { isDark } = useTheme();

  const files = [
    { name: 'girl.jpg', size: '59.67 KB', date: '2025-02-25 04:33:21', type: 'image' },
    { name: 'cycle.jpg', size: '49.38 KB', date: '2025-02-25 04:32:57', type: 'image' },
    { name: 'dp8.jpg', size: '79.20 KB', date: '2025-02-25 04:32:38', type: 'image' },
  ];
